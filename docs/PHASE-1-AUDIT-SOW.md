...
This SOW reflects the investigation path used in [spring-perf-rescue-lab](https://github.com/muhammadahmed-01/spring-perf-rescue-lab): 111 queries to 1, p95 1,605 ms to 696 ms under 100,000 k6 requests (100 VUs) on an N+1 orders list. Production audits follow the same sequence at larger scale.
